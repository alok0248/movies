...
urlpatterns = [
    ...
    path('admin-dashboard/synced-users/<int:user_id>/resend-verification/', views.synced_user_resend_verification, name='synced_user_resend_verification'),
    ...
    path('admin-dashboard/android-apps/<int:app_id>/analytics/device/<str:user_id>/logs/', views.android_device_logs, name='android_device_logs'),
    path('admin-dashboard/android-apps/<int:app_id>/analytics/app-logs/', views.android_app_logs_page, name='android_app_logs_page'),
    path('admin-dashboard/android-apps/<int:app_id>/analytics/app-logs/<int:log_id>/delete/', views.android_app_log_delete, name='android_app_log_delete'),
    path('admin-dashboard/android-apps/<int:app_id>/analytics/app-logs/clear/', views.android_app_logs_clear, name='android_app_logs_clear'),
    path('admin-dashboard/android-apps/<int:app_id>/analytics/clear/<str:data_type>/', views.android_app_clear_data, name='android_app_clear_data'),
    ...
    path('api/android-apps/<slug:app_slug>/log/', views.android_app_log_endpoint, name='android_app_log_endpoint'),
    ...
    path('ajax/home-initial-data/', views.home_initial_data),
    ...
    path('ajax/verify-email-otp/', views.ajax_verify_email_otp, name='ajax_verify_email_otp'),
    ...
    path('direct-player/', views.direct_player_view, name='direct_player'),
    path('ajax/player-subtitles/', views.player_subtitles_view, name='player_subtitles'),
    path('ajax/stremio-subtitles/', views.stremio_subtitles_view, name='stremio_subtitles'),
    ...
    path('admin-dashboard/users/bulk/email/', views.bulk_send_email, name='bulk_send_email'),
    path('admin-dashboard/users/bulk/plan/', views.bulk_change_plan, name='bulk_change_plan'),
    path('admin-dashboard/users/bulk/delete/', views.bulk_delete_users, name='bulk_delete_users'),
    path('admin-dashboard/content/', views.admin_content_list, name='admin_content_list'),
    path('admin-dashboard/content/add/', views.admin_content_add, name='admin_content_add'),
    path('admin-dashboard/content/<str:content_type>/<int:content_id>/edit/', views.admin_content_edit, name='admin_content_edit'),
    path('admin-dashboard/content/<str:content_type>/<int:content_id>/delete/', views.admin_content_delete, name='admin_content_delete'),
